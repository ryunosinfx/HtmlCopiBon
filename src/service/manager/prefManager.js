import {Prefarence} from "../../entity/prefarence";
...
export class PrefManager {
  ...
  async loadAll() {
    ...
    for (let prefarence of prefarences) {
  ...
  async save(pk, name, pageNum, startPage, pageDirection,outputProfile, listing = 0) {
    ...
    prefarences.name = name || name === null
      ? name
      : prefarences.name;
    prefarences.pageNum = pageNum
      ? pageNum
      : 8;
    prefarences.startPage = startPage || startPage === null
      ? startPage
      : prefarences.startPage;
    prefarences.pageDirection = pageDirection || pageDirection === null
      ? pageDirection
      : prefarences.pageDirection;
    prefarences.outputProfile = outputProfile || outputProfile === null
      ? outputProfile
      : prefarences.outputProfile;
    prefarences.listing = listing || listing === null
      ? listing
      : prefarences.listing;
