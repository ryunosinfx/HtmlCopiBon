...
export class ImageDetail extends BaseView {
	...
	render(store, actionData) {
		...
		const titleBar = div("", ["ImageDetailTitle"], [title, toNativeSizeButton, toWindowSizeButton, toDoubleWindowSizeButton, toQuadWindowSizeButton, toHelfWindowSizeButton]);
