...
const vtags = (tagName, id, classNames, data = {}, children, text) => {
	const id1 = tagName + (id && typeof id === 'string' ? '#' + id : '');
	const id2 =
		id1 +
		(classNames
	...
	const currentText = text
		...
		? classNames
		: '';
	let currentData = typeof data === 'string' || Array.isArray(data) ? {} : data;
	if (
		children !== void 0 &&
		text === void 0 &&
		classNames &&
	...
	} else if (children === void 0 && text === void 0 && id && !Array.isArray(id) && typeof id === 'object') {
		currentData = id;
	}
	const toString = Object.prototype.toString;
	// console.log(
	// 	`●id2:${id2}/${typeof currentData}/currentData:${currentData}/toString:${toString.call(
	// 		currentData
	// 	)}/children:${childrenArray}/${Array.isArray(childrenArray)}/text:${currentText}`
	// );
	const childNode = childrenArray.length > 0 ? childrenArray : currentText;
	const newVnode = ESVnode.h(id2, currentData, childNode);
	// alert('aa');
